...
function HeroSection() {
  return (
    <div className='mt-16 p-1 overflow-hidden'>
        <section className="h-screen bg-center bg-cover flex relative">
        ...
        <div className="absolute flex flex-col ml-46 -mt-15 justify-center h-full text-secondary text-center px-6">
